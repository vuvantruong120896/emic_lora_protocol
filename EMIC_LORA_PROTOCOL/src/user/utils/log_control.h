 ...
 * log_error(format, ...)
 * Log error messages
 * Usage: log_error("text") or log_error("format %d", val)
 */
 ...
 * Usage: log_warn("text") or log_warn("format %d", val)
 */
#define log_warn(fmt, ...) \
    do { \
 ...
 * log_info(format, ...)
 * Log info messages
 * Usage: log_info("text") or log_info("format %d", val)
 */
#define log_info(fmt, ...) \
    do { \
 ...
 * log_debug(format, ...)
 * Log debug messages
 * Usage: log_debug("text") or log_debug("format %d", val)
 */
 ...
 * Usage: log_verbose("text") or log_verbose("format %d", val)
 */
